...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Assalamu'alaikum acchan", "Aku punya pertanyaan niiii", "question").then(function () {
    Swal.fire("Jawab jujur yaa bang").then(function () {
      Swal.fire("Awass kalooo boong", "", "error").then(function () {
        ...
        const {
          ...
          const pertanyaan = Swal.fire({
            title: `${Acchan} sayang ga sama ${Nu}?`,
            showDenyButton: true,
            ...
            if (result.isConfirmed) {
              Swal.fire(`${Nu} juga sayang banget sama ${Acchan}`).then(function () {
                Swal.fire({
                  ...
                  val = e.value
                  Swal.fire(`Makasih banget ya udah sayang sama ${Nu} ${val}%`).then(function () {
                    Swal.fire({
                      title: `Sekarang ${Acchan} kangen ga sama ${Nu}?`,
                      showDenyButton: true,
                      showCancelButton: false,
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Huhuhuhuhuhu iya ${Nu} juga kangen bangett samaaa ${Acchan} , makasihhh yaa :)`).then(function () {
